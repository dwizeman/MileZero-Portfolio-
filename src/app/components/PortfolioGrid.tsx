...
const projects: Project[] = [
  ...
  { id: 20, name: 'Your AI Companion',           label: 'PRODUCT UX / UI',        year: '2024', category: 'Museum of Tolerance', to: '/ai-companion', thumbnail: '/ai-companion/thumbnail.jpg' },
...
export default function PortfolioGrid() {
  ...
  const fullyHiddenIds = [17, 1, 2]; // hidden from everyone (admin included); code/assets stay in the repo
